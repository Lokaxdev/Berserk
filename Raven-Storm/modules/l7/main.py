...
THE USER ALONE IS RESPONSIBLE, BE IT: ABUSING BERSERK
TO FIT ILLEGAL PURPOSES OR ACCIDENTAL DAMAGE CAUSED BY BERSERK.
...
BERSERK SHOULD NOT SUGGEST PEOPLE TO PERFORM ILLEGAL ACTIVITIES.
